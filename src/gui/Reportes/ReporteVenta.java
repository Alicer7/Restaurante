...
public class ReporteVenta extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 364, 112, 28));
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 364, 98, 28));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            for (int i = 0; i < jtReporte.getColumnCount(); i++) {
                jtReporte.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
            }
