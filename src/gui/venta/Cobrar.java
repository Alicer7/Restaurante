...
import static gui.venta.Ventas.IDVENTATEMPORAL;
...
//PARTE 3 - FIN -
    ...
    Integer puede = new Integer(gui.venta.Ventas.IDVENTATEMPORAL);
    ...
    private void mostrarVentasDetalleNumeroFactura(Integer valor) throws BadLocationException {
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            jEditorPane_View_.setText( Integer.toString(lista.get(i).getBebidaId()));
//                    
//            filaData[i][7] = lista.get(i).getBebidaCantidad();
//            filaData[i][8] = "Q " + lista.get(i).getCosto();
//            
