 ...
 * @author Alicer
 */
public class ingreso_disponible_onzas extends javax.swing.JFrame {
...
//    }
     ...
     */
    public ingreso_disponible_onzas() {
        initComponents();
//        tabla();
//        popuptable();
//
...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (filas < 0) {
            ...
            String onzas = JOptionPane.showInputDialog(null, "Ingrese la cantidad", "Cantidad otorgada", JOptionPane.WARNING_MESSAGE);
            Double onzas_bot = Double.parseDouble(onzas);

            Double total = cantidad * onzas_bot;

            System.out.println("cantidad " + cantidad);
            System.out.println("onzas " + onzas_bot);
            System.out.println("total onzas " + total);
...
//                ps.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ingreso_disponible_onzas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ingreso_disponible_onzas().setVisible(true);
            }
        });
    }
