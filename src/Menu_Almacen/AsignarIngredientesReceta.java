 ...
 * @author Alicer
 */
public class AsignarIngredientesReceta extends javax.swing.JFrame {
     ...
     */
    public AsignarIngredientesReceta() {
        initComponents();
        tabla();
        popuptable();
...
//        jtProductos.setModel(modelo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsignarIngredientesReceta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsignarIngredientesReceta().setVisible(true);
            }
        });
    }
