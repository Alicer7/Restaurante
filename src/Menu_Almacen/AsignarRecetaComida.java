 ...
 * @author Alicer
 */
public class AsignarRecetaComida extends javax.swing.JDialog {

    /**
     * Creates new form NewJDialog
     */
    public AsignarRecetaComida(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsignarRecetaComida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AsignarRecetaComida dialog = new AsignarRecetaComida(new javax.swing.JFrame(), true);
