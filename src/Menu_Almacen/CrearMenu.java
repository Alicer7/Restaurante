...
import Menu_Almacen.NuevoNombreReceta;
 ...
 * @author Alicer
 */
public class CrearMenu extends javax.swing.JDialog {

    /**
     * Creates new form NewJDialog
     */
    public CrearMenu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CrearMenu dialog = new CrearMenu(new javax.swing.JFrame(), true);
