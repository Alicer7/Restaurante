 ...
 * @author Alicer
 */
public class Materia_Prima_bb extends javax.swing.JDialog {

    /**
     * Creates new form Almacen_materia_prima
     */
    public Materia_Prima_bb(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
...
//        txtMinOnzas.setText(Integer.toString(onzas));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Materia_Prima_bb.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Materia_Prima_bb dialog = new Materia_Prima_bb(new javax.swing.JFrame(), true);
