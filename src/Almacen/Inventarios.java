 ...
 * @author Alicer
 */
public class Inventarios extends javax.swing.JDialog {

    /**
     * Creates new form Inventarios
     */
    public Inventarios(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        Almacen.RegistroAlmacen almacen = new Almacen.RegistroAlmacen(null, true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Inventarios dialog = new Inventarios(new javax.swing.JFrame(), true);
